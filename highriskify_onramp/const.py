...
TRACKING_PLUGIN_VERSION = 'odoo-17.0.1.2.1-final-callback-order-tracking'
...
DEFAULT_CHECKOUT_DESCRIPTION = 'Please select one of the available licensed payment providers to complete your payment. To avoid transaction failure do NOT change values on the payment page. Once a transaction is completed by the selected payment provider you will receive a confirmation email and original merchant website will be instantly notified.'
