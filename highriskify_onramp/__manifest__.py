{
    ...
    'summary': 'Odoo 19 hosted onramp checkout integration for fiat-to-crypto, card-to-crypto, bank transfer, digital asset checkout, multi-provider routing, payment links, invoice checkout, subscription billing, regional checkout support, and transaction synchronization.',
    'description': """
HighRiskify Onramp is a hosted checkout integration for Odoo 19 that connects Odoo Ecommerce, Odoo Website, Odoo Invoicing, and compatible subscription billing workflows with configured onramp checkout services.
