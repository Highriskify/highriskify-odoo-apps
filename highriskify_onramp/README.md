# Payment Provider: HighRiskify Onramp for Odoo 18

This module adds a HighRiskify hosted onramp payment provider to Odoo 18.
...
1. Copy the `highriskify_onramp` folder into your Odoo 18 addons path.
2. Restart Odoo.
...
- Updates Odoo 18 manifest/version references and module namespace references.
- Uses the Odoo 18 payment provider redirect-form hook and explicitly disables inline form rendering for the redirect flow.
