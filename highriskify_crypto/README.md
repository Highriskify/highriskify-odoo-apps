# HighRiskify Crypto for Odoo 18

HighRiskify Crypto adds a hosted, non-custodial crypto checkout integration to Odoo 18.
...
1. Upload/copy the `highriskify_crypto` folder into your Odoo 18 custom addons path.
2. Restart Odoo.
