...
HighRiskify Crypto adds a hosted, non-custodial crypto checkout integration to Odoo 17.
...
1. Upload/copy the `highriskify_crypto` folder into your Odoo 17 custom addons path.
2. Restart Odoo.
