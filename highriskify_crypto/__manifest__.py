{
    ...
    'summary': 'Odoo 19 crypto payment gateway for eCommerce, website checkout, invoices, payment links, Bitcoin, Ethereum, USDT, USDC, stablecoins, QR code payments, hosted crypto checkout, multi-chain blockchain payments, webhook synchronization, and non-custodial wallet settlement.',
    'description': """
HighRiskify Crypto is a hosted non-custodial crypto payment gateway integration for Odoo 19. It connects Odoo Ecommerce, Odoo Website, Odoo Invoicing, and compatible payment workflows with HighRiskify hosted crypto checkout services.
